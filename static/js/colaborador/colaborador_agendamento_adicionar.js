/**
 * JavaScript para página de agendamento do colaborador - Adicionar
...
async function confirmAppointment() {
    ...
    try {
        ...
        const params = new URLSearchParams({
            ...
            cod_doador: codUsuario
        });

        window.location.href = `/colaborador/agendamento/adicionar/confirmacao?${params.toString()}`;
    } catch (error) {
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Página de agendamento do colaborador carregada');
