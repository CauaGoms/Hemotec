...
async function loadNotifications() {
    try {
        const response = await fetch('/api/colaborador/notificacoes');
...
async function markAsRead(notificationId) {
    try {
        const response = await fetch(`/api/colaborador/notificacoes/${notificationId}/marcar-lida`, {
            method: 'POST',
            headers: {
...
async function markAllAsRead() {
    ...
    try {
        const response = await fetch('/api/colaborador/notificacoes/marcar-todas-lidas', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            }
...
async function deleteNotification(notificationId) {
    ...
    try {
        const response = await fetch(`/api/colaborador/notificacoes/${notificationId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
...
async function clearAllNotifications() {
    ...
    try {
        const response = await fetch('/api/colaborador/notificacoes/limpar-todas', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
