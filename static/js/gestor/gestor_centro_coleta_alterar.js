// Alterar Centro de Coleta - JavaScript
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('formAlterarCentro');
    ...
    if (form) {
        form.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch(`/api/gestor/centro-coleta/alterar/${unidadeId}`, {
                    method: 'POST',
                    headers: {
                ...
                if (response.ok) {
                    alert('Centro de coleta atualizado com sucesso!');
                ...
                alert('Erro ao atualizar centro de coleta');
            }
        });
    }
});
