...
@router.get("/colaborador/campanha/excluir/{cod_campanha}")
async def get_colaborador_campanha_excluir(request: Request, cod_campanha: int):
    ...
    response = templates.TemplateResponse("colaborador/colaborador_campanha_excluir.html", {
        "request": request, 
...
@router.post("/colaborador/campanha/excluir/{cod_campanha}/confirmar")
async def post_colaborador_campanha_excluir_confirmar(request: Request, cod_campanha: int):
