...
async def get_colaborador_campanha_adicionar(request: Request, usuario_logado: dict = None):
    response = templates.TemplateResponse(
        "colaborador/colaborador_campanha_adicionar.html", 
        {
            "request": request, 
...
@router.post("/api/colaborador/campanha/adicionar")
@requer_autenticacao(["colaborador"])
async def post_colaborador_campanha_adicionar(
    request: Request,
    titulo: str = Form(...),
    descricao: str = Form(...),
