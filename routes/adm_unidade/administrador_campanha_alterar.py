...
@router.get("/administrador/campanha/alterar/{cod_campanha}")
@requer_autenticacao(["administrador"])
async def get_administrador_campanha_alterar(request: Request, cod_campanha: int, usuario_logado: dict = None):
    ...
    response = templates.TemplateResponse("adm_unidade/administrador_campanha_alterar.html", {
        "request": request, 
...
@router.post("/api/administrador/campanha/alterar/{cod_campanha}")
@requer_autenticacao(["administrador"])
async def post_administrador_campanha_alterar(
    request: Request,
    cod_campanha: int,
    titulo: str = Form(...),
    descricao: str = Form(...),
