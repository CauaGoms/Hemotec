from data.repo import gestor_repo, usuario_repo, instituicao_repo
...
class TestGestorRepo:
    ...
    def test_obter_por_id_existente(self, test_db, gestor_exemplo, usuario_exemplo, instituicao_exemplo):
        #Arrange
